    ...
    <div className="w-full sm:w-1/2 lg:w-1/3 p-2" key={index}>
        <div className="p-10 border border-neutral-700 rounded-xl">
          <p className='text-4xl mb-8'>
            {option.title}
            {option.title === "Pro" && <span className='bg-gradient-to-r text-[20px] from-orange-500 to-orange-800 bg-clip-text text-transparent'>(Most Popular) </span>}
             </p>
             <p className='mb-8'>
             ...
             border border-orange-900/65 rounded-lg transition duration-200'> Subscribe</a>
        </div>
    </div>
))}
</div>
